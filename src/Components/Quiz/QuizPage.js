...
class QuizPage extends Component {
    ...
    getNextQuestion = (quiz) => {
        if (quiz.question.length > this.state.currentQuestionIndex) {
            if (
                this.state.answer ===
                quiz.question[this.state.currentQuestionIndex].answer
            ) {
                this.setState({
                    correctSubmit: true,
            ...
            if (this.state.finishQuiz === false) {
                                ...
                                <form onSubmit={this.handleSubmit} className=''>
                                    <div className='row center-align'>
                                        ...
                                        <div className='col s2'>
                                            ...
                                            false ? (
                                                <i className='material-icons medium red'>
                                                    clear
                                                </i>
                                            ) : null}
                                            {this.state.correctSubmit ===
                                            true ? (
                                                <i className='material-icons medium green'>
                                                    check
                                                </i>
                                            ) : null}
                                        </div>
                ...
                return (
                    ...
                    >
                        <ResultsPage
                            back={this.back}
                            correctNum={this.state.correctAnswers}
                            questionsNum={quiz.question.length}
                        />
                    </motion.div>
                );
            }
